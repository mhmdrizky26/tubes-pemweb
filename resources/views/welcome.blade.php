					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="#home"><img src="{{ asset('bahan-tubes/img/InsightHub__2__1-removebg-preview.png') }}" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							<h2>Kategori</h2>
							<i class="fa-solid fa-rectangle-list"style="font-size: 50px; color: #007bff;"></i>
